test_that("clcc_mc_spodumene function returns desired output", {

  data_path <- "example_data"

  clcc_mc <- clcc_mc_spodumene(data_path)

  clcc_mc_det <- clcc_mc_spodumene(data_path, prob_inf_alt = TRUE)
